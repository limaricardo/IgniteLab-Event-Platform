...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', availableAt?: any | null, slug: string, lessonType: LessonType, title: string, id: string }> };
